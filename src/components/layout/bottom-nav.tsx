...
export function BottomNav() {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 flex items-center justify-around rounded-t-xl border-t border-outline-variant/20 bg-surface-container-lowest px-2 pb-4 pt-2 md:hidden"
      id="bottom-nav"
